...
<section class="questionnaire-section">
    <div class="container">
        ...
        <form action="{{ route('questionnaire.submit') }}" method="post">
            ...
            <div class="question-card">
                <h3>2. Sebutkan sumber dana dalam pembiayaan kuliah?</h3>
            ...
            <div class="question-card">
                <h3>4. Pada saat ini, pada tingkat mana kompetensi di bawah ini diperlukan dalam pekerjaan?</h3>
                @foreach(['Etika', 'Keahlian Berdasarkan Bidang Ilmu', 'Bahasa Inggris', 'Penggunaan Teknologi Informasi', 'Komunikasi', 'Kerjasama Tim', 'Pengembangan'] as $kompetensi)
            ...
            <div class="question-card">
                <h3>5. Menurut Anda seberapa besar penekanan pada metode pembelajaran berikut dilaksanakan di program studi Anda?</h3>
            ...
            <div class="question-card">
                <h3>6. Kapan Anda mulai mencari pekerjaan?</h3>
            ...
            <div class="question-card">
                <h3>7. Bagaimana Anda mencari pekerjaan tersebut? (Jawaban bisa lebih dari satu)</h3>
            ...
            <div class="question-card">
                <h3>8. Berapa perusahaan/instansi/institusi yang sudah Anda lamar (lewat surat atau e-mail) sebelum Anda memperoleh pekerjaan pertama?</h3>
                <input type="number" name="jumlah_perusahaan_dilamar" required>
            </div>

            <!-- Jumlah Respon yang Diterima -->
            <div class="question-card">
                <h3>9. Berapa banyak perusahaan/instansi/institusi yang merespons lamaran Anda?</h3>
                <input type="number" name="jumlah_respons" required>
            </div>

            <!-- Jumlah Wawancara yang Diundang -->
            <div class="question-card">
                <h3>10. Berapa banyak perusahaan/instansi/institusi yang mengundang Anda untuk wawancara?</h3>
                <input type="number" name="jumlah_undangan_wawancara" required>
            </div>

            <!-- Apakah Aktif Mencari Pekerjaan -->
            <div class="question-card">
                <h3>11. Apakah Anda aktif mencari pekerjaan dalam 4 minggu terakhir?</h3>
            ...
            <div class="question-card">
                <h3>12. Jika menurut Anda pekerjaan Anda saat ini tidak sesuai dengan pendidikan Anda, mengapa Anda mengambilnya? (Jawaban bisa lebih dari satu)</h3>
