...
<script>
    ...
    @foreach ([
        ...
        <div>
            <label>
                <input type="radio" name="jenis_perusahaan" value="{{ $jenis_perusahaan }}" 
                    id="{{ $jenis_perusahaan === 'Lainnya' ? 'option_lainnya_1' : '' }}">
                {{ $jenis_perusahaan }}
            </label>
        </div>
    @endforeach
    ...
    <div id="input_lainnya_container_1" style="display: none; margin-top: 10px;">
        <input type="text" name="jenis_perusahaan_lainnya" id="input_lainnya_1" placeholder="Tuliskan lainnya..." style="width: 100%; padding: 8px;">
    </div>
</div>
      ...
      <div class="question-card">
        ...
        <div>
          <label>
            <input type="radio" name="hubungan_bidang_studi" value="Sangat Erat" required> Sangat Erat
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="hubungan_bidang_studi" value="Erat" required> Erat
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="hubungan_bidang_studi" value="Cukup Erat" required> Cukup Erat
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="hubungan_bidang_studi" value="Kurang Erat" required> Kurang Erat
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="hubungan_bidang_studi" value="Tidak Sama Sekali" required> Tidak Sama Sekali
          </label>
        </div>
      </div>
      <div class="question-card">
        ...
        <div>
          <label>
            <input type="radio" name="tingkat_pendidikan" value="Setingkat Lebih Tinggi" required> Setingkat Lebih Tinggi
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="tingkat_pendidikan" value="Tingkat yang Sama" required> Tingkat yang Sama
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="tingkat_pendidikan" value="Setingkat Lebih Rendah" required> Setingkat Lebih Rendah
          </label>
        </div>
        <div>
          <label>
            <input type="radio" name="tingkat_pendidikan" value="Tidak Perlu Pendidikan Tinggi" required> Tidak Perlu Pendidikan Tinggi
          </label>
        </div>
      </div>
     <div class="question-card">
